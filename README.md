...
1. [Fork e repositório GitHub](#1-fork-e-repositório-github)
2. [Instalar o ArgoCD no cluster local](#2-instalar-o-argocd-no-cluster-local)
3. [Acessar e criar um app localmente no ArgoCD](#3-acesso-e-criar-um-app-localmente-no-argocd)
4. [Acessar o front-end](#4-acessar-o-front-end)
5. [(**EXTRA**) Customizando o manifest.yaml](#5-extra-customizando-o-manifestyaml)
6. [(**EXTRA**) Criar um app com um repositório privado](#6-extra-criar-um-app-com-um-repositório-privado)
